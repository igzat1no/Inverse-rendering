...
class TensoirSyntheticDataset(Dataset):
...
if __name__ == '__main__':
    # print working path
    print(os.getcwd())
    nw = TensoirSyntheticDataset('data/tensoir/lego', split='val', downsample=1, is_stack=True)
    ...
    for i in range(10):
        ...
        # for j in range(10):
        #     nw_mask = mask[j]
        #     print(nw_mask.shape, nw_mask.max(), nw_mask.min(), nw_mask.sum())
        # print(nw)