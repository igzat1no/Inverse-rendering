...
from models.tensoIR.sh import eval_sh_bases
import numpy as np
import time
from models.tensoIR.relight_utils import linear2srgb_torch
from dataset.utils import safe_l2_normalize
from models.tensoIR.relight_utils import render_with_BRDF
from utils import *
...
class TensorBase(torch.nn.Module):
    def __init__(self, aabb, gridSize, device, args,
                 density_n_comp=8,
    ...
    def cal_loss(self, data, args):
        ...
        = self.forward(rays, light_idx, is_train=True, white_bg=args.white_bg, is_relight=args.relight_flag, ndc_ray=args.ndc_ray, N_samples=args.nSamples)
